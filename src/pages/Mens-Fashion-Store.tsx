...
const MensFashionStore: React.FC = () => {
  ...
  // Sample product data for men's fashion
  ...
  // Available filters
  const categories = ["All", "Shirts", "Pants", "Suits"];
  const sizes = ["All", "XS", "S", "M", "L", "XL"];
  const colors = ["All", "White", "Blue", "Black", "Gray", "Navy", "Red"];
      ...
      <section className="bg-white border-b border-gray-200 py-4 sticky top-20 z-20">
        <div className="container mx-auto px-4 flex flex-wrap items-center justify-between space-y-2 md:space-y-0">
          ...
          <div className="flex flex-wrap space-x-4 items-center">
            ...
            {/* Size Dropdown */}
            <select value={sizeFilter} onChange={(e) => setSizeFilter(e.target.value)} className="border border-gray-300 rounded px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-16 border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500"
              />
              <span>-</span>
              <input
                type="number"
                ...
                <div className="md:w-1/2 p-6 md:p-8">
                  ...
                  <div className="mt-6">
                    ...
                    <select
                      ...
                      className="border border-gray-300 rounded px-3 py-1 mt-1 w-full focus:outline-none focus:ring-2 focus:ring-pink-500"
                    >
