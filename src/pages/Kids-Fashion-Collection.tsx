    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="flex items-center justify-between py-3">
        <div className="flex items-center space-x-4">
          <a
            href="https://readdy.ai/home/df6ccbb7-9c3b-4e11-9011-dd80609b3302/533b25bb-d4cd-4ad0-848d-fc4146ea7ee2"
            data-readdy="true"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><button className="text-gray-400 hover:text-white cursor-pointer whitespace-nowrap !rounded-button">Guide de taille</button></li>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
        <div className="bg-white rounded-lg max-w-2xl w-full mx-4 p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold">Guide de taille Kids</h2>
            <button
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="px-4 py-2 text-left">Poitrine (cm)</th>
